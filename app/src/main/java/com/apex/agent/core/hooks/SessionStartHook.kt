...
class SessionStartHook : SessionLifecycleHook {
    ...
    /**
     * 加载上次会话上下文摘要
     * 件filesDir 中查找最新的 session_summary_*.json 文件并解果
     * @return 解析后的摘要 JSONObject，若无则返回 null
     */
    ...
    /**
     * 生成环境报告 JSON 字符串，可用于注入到会话初始上下文
     * @param context Android 上下文
     * @return 环境报告 JSON 字符为
     */
