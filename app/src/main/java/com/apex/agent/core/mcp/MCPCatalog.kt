...
class MCPCatalog(private val context: Context) {
    ...
    enum class MCPCategory(val displayName: String, val description: String) {
        PRODUCTIVITY("生产力工具", "文件管理、日历、邮件等 productivity"),
        DEVELOPMENT("开发工具, "代码搜索、API 文档、数据库等开发相关工具),
        AI("AI 工具", "AI 模型集成、向量搜索。embeddings 等"),
        DATA("数据处理", "数据转换、格式处理、数据分析等"),
        COMMUNICATION("通信工具", "Slack、Discord、Teams 等通信平台集成"),
        CLOUD("云服务", "AWS、GCP、Azure 等云服务集成"),
    ...
    suspend fun getCatalog(): List<MCPServerEntry> = withContext(Dispatchers.IO) {
        ...
        listOf(
            ...
            MCPServerEntry(
                id = "slack",
                name = "Slack",
                description = "Slack 集成 - 发送消息、读取频避",
            ...
            MCPServerEntry(
                id = "github",
                name = "GitHub",
                description = "GitHub 集成 - Issues、PRs、代码审查",
                category = MCPCategory.DEVELOPMENT,
                icon = "github",
            ...
            MCPServerEntry(
                ...
                description = "AWS Knowledge Base 检索- 基于 Amazon Bedrock 的知识检索",
                category = MCPCategory.AI,
                icon = "cloud",
            ...
            MCPServerEntry(
                id = "fetch",
                name = "Fetch",
                description = "HTTP 请求工具 - 发通HTTP 请求、API 调用",
            ...
            MCPServerEntry(
                id = "postgres",
                name = "PostgreSQL",
                description = "PostgreSQL 数据应- 完整的SQL 支持",
            ...
            MCPServerEntry(
                id = "sqlite",
                name = "SQLite",
                description = "SQLite 数据应- 轻量级本地数据库",
                category = MCPCategory.DATA,
                icon = "database",
            ...
            MCPServerEntry(
                id = "todoist",
                name = "Todoist",
                description = "Todoist 任务管理 - 创建、管理任务",
                category = MCPCategory.PRODUCTIVITY,
                icon = "check_square",
