...
data class DetectedObject(val placeholder: String = "")
data class BoundingBox(val placeholder: String = "")
data class FaceInfo(val placeholder: String = "")
data class AudioResult(val placeholder: String = "")
...
data class AudioProcessingOptions(val placeholder: String = "")
data class VideoProcessingOptions(val placeholder: String = "")
