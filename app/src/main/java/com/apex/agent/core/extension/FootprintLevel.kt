 ...
 *
 * Level 1: Extend existing code (零新增表面积，
 * Level 2: CLI command + skill (零模型工具足迹）
 * Level 3: Service-gated tool (check_fn, 仅配置后出现，
 * Level 4: Plugin (第三方能力）
 * Level 5: MCP Server (工具化非核心能力，
 * Level 6: New Core Tool (最后手段）
 */
