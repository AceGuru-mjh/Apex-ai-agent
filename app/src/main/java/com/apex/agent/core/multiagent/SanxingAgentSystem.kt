...
object SanxingAgentSystem {
    ...
    enum class AgentRole(
        ...
        ZHONGSHU_DECISION(
            displayName = "中书真",
            title = "决策中枢",
            description = "任务拆解、方案制定、分工排期、结果汇总、最终交件",
            colorHex = "#6366F1",
            defaultModel = "gpt-4o"
        ),
        MENXIA_AUDIT(
            displayName = "门下真",
            title = "审核封驳",
            description = "方案合规性审核、执行结果验收、错误驳回、风险拦成",
            colorHex = "#8B5CF6",
        ...
        SHANGSHU_EXECUTION(
            displayName = "尚书真",
            title = "执行总管",
            description = "任务调度、进度管控、异常处理、执行结果归集",
            colorHex = "#EC4899",
        ...
        LIBU_HR(
            displayName = "吏部",
            title = "人事绩效",
            description = "Agent 状态监控、进度考核、异常节点替换、流程同正",
            colorHex = "#F59E0B",
            defaultModel = "gpt-4o-mini"
        ),
        HUBU_DATA(
        ...
        LIBU_CONTENT(
            displayName = "礼部",
            title = "内容创作",
            description = "文案撰写、内容润色、格式规范、品牌合规、文档排版",
            colorHex = "#3B82F6",
            defaultModel = "gpt-4o"
        ),
        BINGBU_STRATEGY(
            displayName = "兵部",
            title = "策略攻坚",
            description = "竞品分析、策略制定、难题攻坚、风险应对、规划设计",
            colorHex = "#EF4444",
            defaultModel = "gpt-4o"
        ),
        XINGBU_COMPLIANCE(
            displayName = "刑部",
            title = "合规风控",
            description = "法务审核、合规校验、漏洞检测、风险排查、内容纠正",
            colorHex = "#A855F7",
            defaultModel = "claude-3.5-sonnet"
        ),
        GONGBU_TECH(
        ...
        YUSHITAI_SUPERVISION(
            displayName = "御史取",
            title = "监察审计",
            description = "全流程审计、API 用量统计、越权拦截、异常告警、日志归案",
            colorHex = "#64748B",
            defaultModel = "gpt-4o-mini"
        )
    }
