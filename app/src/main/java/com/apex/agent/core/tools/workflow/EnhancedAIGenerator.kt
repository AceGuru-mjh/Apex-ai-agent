...
class EnhancedAIGenerator {
    ...
    companion object {
        private val WORKFLOW_TEMPLATES = listOf(
            ...
            WorkflowTemplate(
                ...
                actions = listOf(
                    ...
                    WorkflowAction("批量重命的 "batch_rename", "根据规则重命名文件）
                ),
                complexity = 3
            ),
            WorkflowTemplate(
        ...
        private val TRIGGER_KEYWORDS = mapOf(
            "schedule" to listOf("定时", "每天", "每周", "每月", "时间", "的 "的）,
            "intent" to listOf("收到", "的 "如果", "检查， "触发"),
