...
data class TelemetrySummary(val placeholder: String = "")
data class TelemetryConfig(val placeholder: String = "")
data class TelemetrySnapshot(val placeholder: String = "")
